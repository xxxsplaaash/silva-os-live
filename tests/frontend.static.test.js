...
test('Prompt Generator V3 visual layer is visible, collapsed where needed, and red is restrained', () => {
  ...
  assert.match(script, /Prompt Generator V2/);
  assert.match(script, /pg50-model-drawer/);
  assert.match(script, /pg52-production-status-strip/);
  assert.match(script, /pg52-v2-command-bar/);
  assert.match(script, /pg52-production-command-bar/);
  assert.match(script, /pg52-v2-layout/);
  assert.match(script, /pg52-v2-identity-panel/);
  assert.match(script, /pg52-identity-stage/);
  assert.match(script, /pg52-v2-shot-studio/);
  assert.match(script, /pg52-step-shot/);
  assert.match(script, /pg52-step-scene/);
  assert.match(script, /pg52-step-styling/);
  assert.match(script, /pg52-v2-output-lane/);
  ...
  assert.match(css, /Prompt Generator V2 production console/);
  assert.match(css, /Prompt Generator V2\.1/);
  assert.match(css, /pg52-production-status-strip/);
  assert.match(css, /pg52-production-command-bar/);
  assert.match(css, /pg52-v2-command-bar/);
  assert.match(css, /pg52-v2-layout/);
  assert.match(css, /pg52-v2-identity-panel/);
  assert.match(css, /pg52-identity-stage/);
  assert.match(css, /pg52-v2-shot-studio/);
  assert.match(css, /pg52-creative-step/);
  assert.match(css, /pg52-shot-mode-grid/);
  assert.match(css, /pg52-sa-moment-grid/);
  assert.match(css, /pg52-v2-output-lane/);
