...
- Live generator shell: `#prompt-generator-51-shell` (`Prompt Generator 5.1`) owns the visible shotboard. Older `#prompt-generator-50-shell`, `#prompt-generator-40-shell`, and `#prompt-generator-38-shell` are compatibility/rollback shells only and must not be visible at the same time.
