...
(function(){
  ...
  function workflowStripHtml(){
    return [
      '<nav class="pg52-workflow-strip" aria-label="Prompt Generator V2 workflow">',
  ...
  function renderGeneratorShell52(){
    ...
    shell.innerHTML = [
      '<section class="pg52-shell pg52-v3-shell" aria-label="Prompt Generator atelier console">',
        '<header class="pg52-command-bar pg52-v3-command-bar" aria-label="Character identity and production status">',
          mobileNavButtonHtml(),
          '<div class="pg52-v3-char-block">',
            '<div class="pg52-t-micro">Atelier subject</div>',
            '<div class="pg52-char-name pg52-t-subtitle" id="pg52-char-display">Character</div>',
            '<div class="pg52-char-tags" id="pg52-char-tags"></div>',
          '</div>',
          '<div class="pg52-v3-ref-block">',
            '<div class="pg52-ref-grid" id="pg52-ref-grid"></div>',
            '<label class="pg52-refs-toggle pg52-v3-refs-toggle">',
              ...
              '<span class="pg52-t-label">Refs</span>',
            '</label>',
            '<div class="pg52-readiness-row pg52-v3-readiness-row" id="pg52-readiness-row" title="">',
              '<div class="pg52-readiness-dot" id="pg52-readiness-dot"></div>',
              '<span class="pg52-readiness-label" id="pg52-readiness-label">checking</span>',
            '</div>',
          '</div>',
          '<div class="pg52-v3-status-strip" aria-label="Production status controls">' + productionStatusStripHtml(controls) + '</div>',
          '<div class="pg52-identity-lock-card pg52-v2-identity-lock-card pg52-v3-identity-lock-card" id="pg52-identity-lock-card" aria-live="polite"></div>',
        '</header>',
        '<div class="pg52-workspace pg52-v3-layout">',
          '<aside class="pg52-identity-rail pg52-v3-identity-data" aria-label="Identity data" aria-hidden="true">',
          ...
          '</aside>',
          '<main class="pg52-shot-canvas pg52-v3-canvas" aria-label="Shot studio">',
            '<section class="pg52-launch-card pg52-launch-prompt-preview pg52-v3-canvas-hero" id="pg52-launch-prompt-preview" aria-label="Prompt canvas">',
              '<div class="pg52-v3-canvas-meta">',
                '<span class="pg52-t-micro">Prompt canvas</span>',
                '<strong class="pg52-v3-quality-pill" id="pg52-prompt-quality-pill">Prompt quality: checking</strong>',
                '<button class="pg52-btn-ghost pg52-btn-sm pg52-v3-copy-btn" type="button" onclick="copyText(document.getElementById(\'out-main\')?.textContent || window._lastGenerated?.prompt || \'\', this)">Copy</button>',
              '</div>',
            ...
            '</section>',
            '<section class="pg52-creative-step pg52-step-shot" id="pg52-step-shot" aria-label="Shot mode">',
              shotModeSelectorHtml(),
              '<div class="pg52-v3-shot-support">',
                saMomentStripHtml(),
                quickConfigButtonHtml(),
              '</div>',
            '</section>',
            '<section class="pg52-creative-step pg52-step-scene" id="pg52-scene-section" aria-label="Scene">',
              '<div class="pg52-v3-section-head">',
                '<h3 class="pg52-t-title pg52-v3-section-title" data-pg52-mode-title="scene">' + esc(modeCopy.scene) + '</h3>',
                '<button class="pg52-btn-ghost pg52-btn-sm" type="button" data-pg50-randomize="scene">Randomize</button>',
              '</div>',
              ...
              '<details class="pg52-creative-tools pg52-advanced-drawer" id="pg52-creative-tools" data-pg52-active-tool="concepts">',
                ...
                '<div class="pg52-creative-tools-body">',
                  ...
                  '<div class="pg52-creative-tool-panels">',
                    ...
                    creativeToolPanelHtml('prompt-anatomy', '<div class="pg52-creative-anatomy-note"><span class="pg52-t-micro">Prompt anatomy</span><p>Full anatomy appears in secondary output after generation so the main desk stays usable.</p></div>'),
                  '</div>',
                '</div>',
              '</details>',
            ...
            '<section class="pg52-creative-step pg52-step-styling" id="pg52-step-styling" aria-label="Styling">',
              '<div class="pg52-v3-section-head">',
                '<h3 class="pg52-t-title pg52-v3-section-title" data-pg52-mode-title="wardrobe">' + esc(modeCopy.wardrobe) + '</h3>',
                '<button class="pg52-btn-ghost pg52-btn-sm" type="button" data-pg52-open-wardrobe>+ Wardrobe</button>',
              '</div>',
              ...
              '<div class="pg52-scene-ref-shell" id="pg52-scene-refs-section">',
                '<div class="pg52-section-head pg52-section-head--compact">',
                  '<div class="pg52-section-title-group">',
                    '<span class="pg52-t-label">Refs + aesthetic</span>',
                    '<h3 class="pg52-t-title" data-pg52-mode-title="refs">' + esc(modeCopy.refs) + '</h3>',
                  '</div>',
            ...
            '</section>',
          '</main>',
          '<aside class="pg52-output-rail pg52-v3-output-zone" id="gen-output-panel" aria-label="Generation output">',
            '<section class="pg52-launch-card pg52-launch-quality" id="pg52-launch-quality" aria-label="Prompt quality" hidden>',
              '<div class="pg52-launch-card-head"><span>Quality</span><strong id="pg52-prompt-quality-pill-detail">checking</strong></div>',
            ...
            '<details class="pg52-output-advanced">',
              '<summary><span>Output</span><em>proofing, anatomy, variants, caption, prompt</em></summary>',
              '<div class="pg52-output-accordions">',
                ...
                accordionHtml('pg52-acc-prompt', 'Full prompt'),
              '</div>',
            '</details>',
          '</aside>',
        '</div>',
        '<div class="pg52-v3-footer-bar" role="region" aria-label="Route and generate">',
          '<section class="pg52-route-card pg52-launch-card pg52-v3-route-section" id="g-route-preview" aria-label="Selected route">',
            '<div class="pg52-route-standby pg52-v3-route-standby" id="pg52-route-standby"><strong>Route warming up.</strong><span>Provider path, cost, and reference handling will settle here.</span></div>',
            '<div class="pg52-route-content pg52-v3-route-content" id="pg52-route-content" hidden>',
              '<div class="pg52-v3-route-top">',
                '<div class="pg52-v3-route-info">',
                  '<div class="pg52-route-model pg52-t-subtitle" id="pg52-route-model-name">Nano Banana Pro</div>',
                  '<div class="pg52-route-provider pg52-t-micro" id="pg52-route-provider">Google Vertex AI</div>',
                '</div>',
                '<div class="pg52-v3-route-meta">',
                  '<div class="pg52-cost-num" id="pg52-route-cost-num">R-</div>',
                  '<div class="pg52-readiness-inline" id="pg52-route-readiness">',
                    '<div class="pg52-readiness-dot pg52-readiness-dot--ready"></div>',
                    '<span>ready</span>',
                  '</div>',
                '</div>',
              '</div>',
              '<div class="pg52-route-reason pg52-v3-route-reason" id="pg52-route-reason"></div>',
              ...
              '<div class="pg52-route-actions pg52-v3-route-actions">',
                '<button class="pg52-btn-ghost pg52-btn-sm" id="pg50-model-drawer-toggle" type="button" aria-expanded="false" aria-controls="pg50-model-drawer">Routes</button>',
                '<button class="pg52-route-details-btn" type="button" id="pg52-route-details-btn" aria-expanded="false">Details</button>',
              '</div>',
            ...
            '</div>',
          '</section>',
          '<section class="pg52-launch-card pg52-launch-generate pg52-v3-generate-section" id="pg52-launch-generate" aria-label="Generate final image">',
            '<div class="pg52-v3-generate-actions">',
              '<button class="pg52-btn-ghost pg52-btn-sm pg52-v3-prompt-btn" type="button" onclick="generatePromptFromGenerator(this)">Prompt only</button>',
              '<button class="pg52-generate-btn pg52-generate-btn--full pg52-v3-generate-btn" type="button" onclick="generateImageFromGenerator(this)">Generate ' + generateArrowSvg(16) + '</button>',
            '</div>',
            '<div class="pg52-prompt-actions" aria-label="Prompt copy">',
  ...
  function ensureControls(){
    ...
    if (title) title.textContent = 'Prompt Generator V2';
    if (sub) sub.textContent = 'Production console — character context, shot studio, output lane, final image.';
