 ...
 */
export declare const MAX_CRITIC_CYCLES = 2;
/**
 * Typed vocabulary for critic findings. New issue types require a plan update;
 * do not add ad-hoc strings here.
 */
export type CriticIssueType = "memory_contradiction" | "stale_note_surfaced" | "ungrounded_claim" | "threshold_coherence_failure";
