 ...
 */
export declare class ShadowEvidenceCollector implements IShadowEvidenceCollector {
    private readonly store;
    constructor(store: ShadowEvidenceStore);
    collect(entry: ShadowAuditEntry, collectedAt: string): string | null;
}
/**
 ...
 */
export declare class NoOpShadowEvidenceCollector implements IShadowEvidenceCollector {
