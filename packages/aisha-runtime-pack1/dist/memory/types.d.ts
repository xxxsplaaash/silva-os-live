...
export type BaseMemoryMeta = RecordMeta & Partial<IdentityContext> & Partial<PrivacyContext>;
export interface TurnRecord extends RecordMeta, Partial<IdentityContext>, Partial<PrivacyContext> {
    kind: "turn";
    sessionId: string;
    turnIndex: number;
...
export interface EpisodeRecord extends RecordMeta, Partial<IdentityContext>, Partial<PrivacyContext> {
    kind: "episode";
    sessionId: string;
    threadId: string;
    startTurnId: string;
...
export interface NoteLinkRecord extends RecordMeta {
    ...
    fromNoteId: string;
    toNoteId: string;
    relation: "supports" | "contradicts" | "supersedes" | "derived_from" | "blocks_reinference_for";
    strength?: number;
}
...
export interface INoteVersioning {
    ...
    persistReviewSignals(signals: import("./reactiveReconsolidation").PersistedReviewSignal[], subjectScope: {
