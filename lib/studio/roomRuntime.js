...
const TOPIC_PATTERNS = {
  food: /\b(hungry|food|lunch|dinner|eat|drink|coffee|tea|snack|burger|fries|salad)\b/i,
...
function inferIntentFamily(question = '', resolution = {}, system = {}) {
  ...
  if (/\b(hungry|food|lunch|dinner|eat|drink|coffee|tea|snack|burger|fries|salad)\b/.test(q)) return 'food-room';
