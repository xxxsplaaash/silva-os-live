...
function hasInventedProjectSpecifics(text = '', userMessage = '', topic = '') {
  ...
  const inventedOps = /\b(q[1-4] deliverables|quarterly deliverables|project timelines|allocate resources|resource allocation|client meeting slots|client meetings|meeting slots|confirm the client|client schedule|stakeholder sync|stakeholder alignment)\b/.test(text);
