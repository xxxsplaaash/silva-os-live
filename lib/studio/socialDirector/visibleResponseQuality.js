...
function hasGenericAdvice(text = '') {
  const markers = [
    ...
    /\b(start with three rounds of your chosen exercises|chosen exercises|focus on clean form|move with intention|just show up for those twenty minutes|sustainable routine|tracking your progress|listed movements|building a habit|showing up and moving)\b/,
