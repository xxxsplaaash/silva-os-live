  ...
  if (/sad|waste of time|stressed|tired|hurt|lonely/i.test(text)) {
    return {
      ...
      speakers: [
        ...
        speaker('claudia', 'side', 'grounded practical', 'Next move: choose the lane you want handled first - body, work, food, or the room - and I will cut the repeats.', 'Tracking next steps')
      ],
