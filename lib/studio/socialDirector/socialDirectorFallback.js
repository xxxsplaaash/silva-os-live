...
function socialFallbackFor(message = {}, body = {}) {
  ...
  if (/sad|waste of time|stressed|tired|hurt|lonely/i.test(text)) {
    return {
      ...
      responseMode: 'small_exchange',
      speakers: [
        speaker('vanya', 'primary', 'warm specific', 'Fair. Breathe first; shrink the room to water, one clear surface, and ten minutes that do not need a dramatic reset.', 'Protective'),
