    ...
    return {
      ...
      speakers: [
        ...
        speaker('claudia', 'side', 'dry practical', wantsToday
          ...
          : 'Next answer gets one concrete action, one owner, and one measurable next move.', 'Tracking next steps'),
        speaker('grok', 'closer', 'dry diagnostic', wantsToday
          ? 'Premise stays simple: do the first block before reopening the debate. Bring back the result, not another argument.'
          : 'Correct. Repetition is a premise fault: a failed answer with confidence. Cut it.', 'Tracking failure')
      ],
      silentReactions: [reaction('aisha', 'Anchoring'), reaction('leah', 'Watching')],
