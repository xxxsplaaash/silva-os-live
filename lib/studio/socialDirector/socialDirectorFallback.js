...
function socialFallbackFor(message = {}, body = {}) {
  ...
  if (/\b(20 minutes?|twenty minutes?|only have \d+\s*minutes|limited time)\b/i.test(text) && hasFitnessContext(text, body)) {
    ...
    return {
      ...
      responseMode: 'small_exchange',
      speakers: [
        speaker('claudia', 'primary', 'practical', 'Twenty minutes: warm up for 3, then two rounds of push, pull, legs, hinge, and core. Write the lowest rep count down.', 'Tracking next steps'),
