    ...
    return {
      ...
      speakers: [
        ...
        speaker('claudia', 'side', 'dry practical', freshLine(body, [
          'First step: put the new value in the work column; park the old value beside it for comparison.',
          'Structure it: build from the new value; leave the old value in the comparison column.',
          'Structure: new value drives the next design choice; old value stays parked for contrast.'
        ]), 'Tracking next steps')
      ],
  ...
  if (active && prior) {
    return {
      ...
      speakers: [
        ...
        speaker('claudia', 'side', 'dry practical', freshLine(body, [
          'First step: current value drives the work; old value stays parked for comparison.',
          'First step: use the current value; keep the old value in the comparison column.',
          'Structure: archive answers old value; current value drives the next move.'
        ]), 'Tracking next steps')
      ],
      silentReactions: [reaction('vanya', 'Reading the room'), reaction('grok', 'Tracking')],
...
function continuityClaimFallback(text = '', body = {}) {
  ...
  if (isUpdate) {
    return {
      ...
      speakers: [
        ...
        speaker('claudia', 'side', 'dry practical', freshLine(body, [
          'First step: build from the current value; park the prior value beside it for comparison.',
          'First step: current value leads the work; prior value stays in the comparison column.',
          'Structure: current value drives; prior value stays visible until it is only contrast.'
        ]), 'Tracking next steps')
      ],
      silentReactions: [reaction('vanya', 'Reading the room'), reaction('grok', 'Tracking')],
      stateUpdates: {
  ...
  return {
    ...
    speakers: [
      ...
      speaker('claudia', 'side', 'dry practical', 'First step if this changes later: compare old and new before designing more. No quiet erasure.', 'Tracking next steps')
    ],
    silentReactions: [reaction('vanya', 'Reading the room'), reaction('grok', 'Tracking')],
