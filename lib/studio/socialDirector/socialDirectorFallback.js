    ...
    return {
      ...
      speakers: [
        ...
        speaker('claudia', 'side', 'dry practical', freshLine(body, [
          'One decision: use the new value for the work; keep the old value only as evidence.',
          'Structure: old value archived, new value drives the next design choice.',
          'Next move: design from the new value, with the old value visible for comparison.'
        ]), 'Tracking next steps')
      ],
