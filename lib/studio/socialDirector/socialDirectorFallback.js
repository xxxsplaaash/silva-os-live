    ...
    return {
      ...
      speakers: [
        ...
        speaker('claudia', 'side', 'dry practical', freshLine(body, [
          'One decision: current value leads. Keep the prior value visible; design from the current one.',
          'Structure: compare current value against prior value, then decide from the current one. No rewrite needed.',
  ...
  if (active && prior) {
    return {
      ...
      speakers: [
        ...
        speaker('claudia', 'side', 'dry practical', freshLine(body, [
          'First step: use the current value going forward; keep the old value only for comparison.',
          'Next move: current value drives the work; old value stays as comparison.',
          'Structure: old value answers the archive; current value guides the work.'
        ]), 'Tracking next steps')
      ],
      silentReactions: [reaction('vanya', 'Reading the room'), reaction('grok', 'Tracking')],
...
function continuityClaimFallback(text = '', body = {}) {
    ...
    return {
      ...
      speakers: [
        ...
        speaker('claudia', 'side', 'dry practical', freshLine(body, [
          ...
          'One decision: current value first; prior value stays visible until it is only comparison.',
          'Structure: compare current value, prior value, then decide from the current one. No rewrite needed.'
        ]), 'Tracking next steps')
      ],
      silentReactions: [reaction('vanya', 'Reading the room'), reaction('grok', 'Tracking')],
      stateUpdates: {
  ...
  return {
    ...
    speakers: [
      ...
      speaker('claudia', 'side', 'dry practical', 'One decision if this changes later: compare old and new before designing more. No quiet erasure.', 'Tracking next steps')
    ],
    silentReactions: [reaction('vanya', 'Reading the room'), reaction('grok', 'Tracking')],
    ...
    return {
      ...
      speakers: [
        ...
        speaker('claudia', 'side', 'dry practical', wantsToday
          ...
          : 'One clean move: next answer gets one shape, one useful move, and no recycled opener.', 'Tracking next steps'),
  ...
  if (/logo|bland|taste|campaign|creative|weak idea/i.test(text)) {
    return {
      ...
      speakers: [
        ...
        speaker('claudia', 'side', 'dry practical', 'Practical cut: simplify the shape, tighten spacing, and give the red accent one job: pulse, cut, or warning. Pick one.', 'Tracking next steps'),
