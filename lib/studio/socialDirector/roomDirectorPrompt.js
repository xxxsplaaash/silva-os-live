...
function hardRules(input = {}) {
  return [
    ...
    'For muscle/fitness asks, give safe beginner structure: consistency, full-body basics, progressive overload, food/protein, sleep/recovery, and caution for pain or medical conditions.',
    ...
    'No advice-column filler: avoid "consistency is key", "adequate protein", "timing is key", "quality over quantity", and "parameters" language.',
    ...
    'If the user asks whether the answer sounded fake or useful, answer that directly with taste and accountability.',
