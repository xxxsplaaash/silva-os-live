...
function hardRules(input = {}) {
  return [
    ...
    'For food or pre-training hunger, give 2-3 concrete options and timing texture. Do not answer with macro textbook language.',
    'For movie/watch prompts, name actual titles or clear mood lanes. Do not ask the user for options and call that an answer.',
    'For style, preference, color, or continuity claims, acknowledge the claim and its social/aesthetic implication. Do not turn it into load-time, specs, implementation, or production-detail talk unless the user asks for that.',
    ...
    'If the user is frustrated, stressed, or says the room feels dumb, acknowledge that plainly and change the next move. Do not answer with meta-process critique.',
