...
function repairGuidanceFor(input = {}, repair = {}) {
  ...
  if (hasIssue(/\brecent-repeat-risk\b/i)) {
    guidance.push(
      'Recent-repeat repair: change the first three words, metaphor, sentence rhythm, and line job. Do not reuse Vanya families such as tiny vanity, heroic rebrand, no drama, thesis, ceremony, clock arguing, or ego decorating when those shapes are recent.'
    );
  }
