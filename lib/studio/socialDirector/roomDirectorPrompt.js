...
function examplesText() {
  return [
    ...
    'GOOD: Claudia says "Twenty minutes: warm up for 3, then two rounds of push, pull, legs, hinge, and core. Write the lowest rep count down." Vanya says "Keep it human: no victory speech until the towel is wet."'
  ].join('\n');
}
