...
function hardRules(input = {}) {
  return [
    ...
    'For silent characters, use silentReactions with safe visible states; silence is presence with a reason, not a broken loading gap.',
    ...
    'No swappable warmth: avoid "I hear you", "thank you for sharing", "your feelings are valid", "that is a valid reaction", "holding space", and other generic support-bot phrases.',
