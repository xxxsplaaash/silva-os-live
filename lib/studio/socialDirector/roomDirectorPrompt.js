...
function hardRules(input = {}) {
  return [
    ...
    'For muscle/fitness asks, never use support-bot encouragement like "that is a great goal", "fuel yourself well", or "enough sleep to support growth". Make the line specific or cut it.',
