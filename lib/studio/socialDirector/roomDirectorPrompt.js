...
function hardRules(input = {}) {
  ...
  return [
    ...
    'For planning-tomorrow asks, Claudia should give a plain day skeleton using real blocks and one owner/risk, not invented agendas, clients, KPIs, deliverables, or EOD reporting.',
...
function examplesText() {
  return [
    ...
    'GOOD: Claudia says "Tomorrow: first block for the hardest task, second block for cleanup, one named owner for the messy handoff. Leave one gap for recovery."',
    'GOOD: Vanya says "Make the afternoon stay human: one hard thing early, one cleanup block, and a breathable gap before the day gets loud."',
