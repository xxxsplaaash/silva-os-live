...
function categoryFor(input = {}) {
  ...
  if (['contradiction', 'creative', 'reference-follow-up', 'practical'].includes(topicClass)) return 'practical';
...
function orderedSpeakersFor(category = 'normal', input = {}) {
  ...
  if (category === 'practical') {
    ...
    if (topicClass === 'reference-follow-up') {
      ...
      const secondPool = first === 'claudia' ? ['vanya', 'grok', 'leah'] : ['grok', 'claudia', 'vanya', 'leah'];
