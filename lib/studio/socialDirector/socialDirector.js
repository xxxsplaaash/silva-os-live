...
function qualityInvalidIssue(issue = '') {
  return /^(allowed-topic-refusal|false-objective-claim|topic-ignored|recent-repeat-risk|takeover-for-ordinary-topic|feels-task-router-risk|repeated-point-risk)/.test(String(issue || ''));
}
