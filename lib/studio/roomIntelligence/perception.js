...
const OPEN_FLOOR_RX = /\b(?:open floor|open the floor|hear from the room|room perspective|whole room perspective|full room perspective|bring the room in|let the room weigh in)\b/i;
